...
<img width="48" height="48" src="https://img.icons8.com/fluency/48/sql.png" alt="sql"/> <img width="48" height="48" src="https://img.icons8.com/fluency/48/power-bi-2021.png" alt="power-bi-2021"/> <img width="48" height="48" src="https://img.icons8.com/color/48/microsoft-excel-2019--v1.png" alt="microsoft-excel-2019--v1"/> 
---

### 📁 Featured Data Analytics Projects
#### 1. [Secure watch SOC DashBoard] 
* **Goal:** Built an interactive dashboard tracking key performance metrics with YOY% change, Monthly incident trends(2023 vs 2024), Threat group rankings (APT28, Lazarus & More),Attack Source by Country & Region.
* **Tech Used:** Power BI.
* **Key Outcome:** Identified  Attack Source by Country & Region, helping them to track and take precautions at right time.
