...
#### 1. [Secure watch SOC DashBoard] (https:\\github.com)
* **Goal:** Built an interactive dashboard tracking key performance metrics with YOY% change, Monthly incident trends(2023 vs 2024), Threat group rankings (APT28, Lazarus & More).
* **Tech Used:** Power BI.
* **Key Outcome:** Identified a Attack Source by Country & Region, helping them to track and take precautions at right time.
